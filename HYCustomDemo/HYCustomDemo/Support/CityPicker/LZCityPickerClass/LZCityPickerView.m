...
- (void)loadData {
    ...
    NSDictionary *allCityInfo = [[NSDictionary alloc]initWithContentsOfFile:cityPath];
    
    NSMutableArray *temp = [NSMutableArray array];
    for (NSInteger i = 0 ; i < [[allCityInfo allKeys] count]; i++){
        NSString *a = [allCityInfo objectForKey:[NSString stringWithFormat:@"%ld",(long)i]];
        NSLog(@"---: %@",a);
